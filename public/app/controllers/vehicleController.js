app.controller('vehicleController', function($scope,$filter, $sessionStorage, $rootScope, $state, $scope, $timeout, UserAuthFactory, AuthenticationFactory, $window, commonFactory, userFactory) {
